...
### Hover Detection
![Hover over any element to see component highlighting](screenshots/hover-detection.png)

### Component Tooltip
![Detailed component information in tooltip](screenshots/tooltip-info.png)

### Extension Popup
![Easy toggle controls in extension popup](screenshots/popup-interface.png)

## 🚧 Roadmap

- [ ] Add React component prop detection
- [ ] Support for Shadow DOM components
